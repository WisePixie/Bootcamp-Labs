...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (continueLoop)
        {
            Console.WriteLine("Hello, " + userName + "! Welcome to the Number Analyzer! Please enter an integer between 1 and 100:");
            int number = Convert.ToInt32(Console.ReadLine());//prompt to greet and ask the user for # input 1-100
            ...
            Console.WriteLine("Do you wish to stop? (Y/N)"); //prompt to continue running or end program 
